<template>
    <svg width="34" height="34" viewBox="0 0 34 34" fill="inherit" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <clipPath id="clip0_0_366">
                <rect width="34" height="34" fill="inherit" transform="matrix(4.37114e-08 1 1 -4.37114e-08 0 0)" />
            </clipPath>
        </defs>
    </svg>
</template>